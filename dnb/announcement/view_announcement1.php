...
try {
    ...
    $query_annc = "SELECT student.USN, announcement.* 
    FROM student 
    LEFT JOIN department ON student.dept_id = department.Dept_ID 
    LEFT JOIN announcement ON department.Dept_ID = announcement.Dept_ID 
    WHERE student.USN = :user_id 
    AND announcement.announcement_type_id = :announcement_type_id";
